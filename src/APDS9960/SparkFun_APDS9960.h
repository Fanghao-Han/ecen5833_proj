...
#ifndef _SparkFun_APDS9960_H
#define _SparkFun_APDS9960_H
...
bool APDS9960_enableLightSensor(bool interrupts);//bool interrupts = false
bool APDS9960_disableLightSensor();
bool APDS9960_enableProximitySensor(bool interrupts);//bool interrupts = false
bool APDS9960_disableProximitySensor();
bool APDS9960_enableGestureSensor(bool interrupts);//bool interrupts = true
